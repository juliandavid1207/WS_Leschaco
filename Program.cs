...
IHost host = Host.CreateDefaultBuilder(args)
    .ConfigureServices((hostContext,services) =>
    {
        ...
        //services.AddHttpClient("ApiLeschaco", client =>
        //{
        //    client.BaseAddress = new Uri("https://test.colsys.com.co:8443/ws/fam/IntegracionFamWS/");

        //    client.DefaultRequestHeaders.Accept.Add(new System.Net.Http.Headers.MediaTypeWithQualityHeaderValue("text/xml"));
        //    client.DefaultRequestHeaders.Add("SOAPAction", "https://test.colsys.com.co:8443/ws/fam/IntegracionFamWS/");
